...
$native = Join-Path $projectRoot 'WindowsIntoOmarchy.exe'
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Windows Into Omarchy" Width="620" Height="430" WindowStartupLocation="CenterScreen"
  ...
  <Grid Margin="42"><Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="*"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
    <StackPanel><TextBlock Text="OM//WIN  COMPATIBILITY" Foreground="#C9FF36" FontFamily="Consolas"/><TextBlock Text="Windows Into Omarchy" FontSize="32" FontWeight="Light" Margin="0,6,0,0"/></StackPanel>
...
$prepare.Add_Click({
    ...
    Start-OmarchyHiddenPowerShell -Script $experience -Arguments @('-Action','PrepareAndLaunch') | Out-Null

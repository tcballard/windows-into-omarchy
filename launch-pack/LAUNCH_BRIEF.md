...
- Primary audience: Windows 11 x64 testers who want to try Omarchy without repartitioning.
- User outcome after publication: download one installer; first launch obtains and verifies the supporting release assets automatically.
- Launch objective: prepare a permanent, tag-bound GitHub prerelease for physical-Windows acceptance.
- Primary call to action: download `Windows-Into-Omarchy-v0.3.0-setup-unsigned.exe` after the draft is published.

## Availability and boundaries

- Automated guest, runtime and assembly gates passed on the pinned source tree.

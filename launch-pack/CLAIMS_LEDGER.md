...
| --- | --- | --- | --- | --- | --- | --- | --- |
| C01 | Windows Into Omarchy prepares a guided QEMU/WHPX VM for Windows 11 x64. | Required | `launcher/`, `scripts/`, runtime lock | Verified | Product implementation, not a completed physical run | README, release | Tom |

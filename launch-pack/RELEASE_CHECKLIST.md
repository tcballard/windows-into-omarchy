...
| --- | --- | --- | --- |
| Identity | Product `Windows Into Omarchy`, version `0.3.0`, tag `v0.3.0-rc.1` | Pass | Preserve exact values |
...
| Naming | No tracked `Onarchy` spelling | Pass | Keep canonical name |

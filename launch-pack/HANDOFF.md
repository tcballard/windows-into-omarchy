...
- Exact next action: merge PR #2, run `prepare-v0.3.0-rc.1-bootstrap-release` on `main`, inspect the verified draft, then complete acceptance/review before choosing **Publish prerelease**

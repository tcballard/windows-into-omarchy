...
After publication, download only `Windows-Into-Omarchy-v0.3.0-setup-unsigned.exe`. The installer is bound to this exact release. On first launch it downloads the supporting runtime and Omarchy factory parts, verifies every SHA-256, reconstructs and verifies the payloads, and starts the contained VM.

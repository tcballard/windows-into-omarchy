...
1. Download and extract `Windows-Into-Onarchy-v0.1.0.zip` on Windows 11 x64.
...
The QEMU Windows distribution describes its builds as experimental and uses an expired signing certificate. Windows Into Onarchy therefore identifies the locked installer by the publisher's SHA-512 before opening it.

## Integrity

`Windows-Into-Onarchy-v0.1.0.zip`

```text
1f3a6ccaa7c4a830dfebec532be0eca717d7b0c3bfd4fcff53d87a34917edcc4
```

Windows Into Onarchy is independent and is not affiliated with or endorsed by Omarchy, Basecamp, Omacom, Microsoft, QEMU, or the original Try Omarchy project.
